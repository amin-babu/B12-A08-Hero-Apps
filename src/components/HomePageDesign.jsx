    ...
    <div>
      <div className='text-center space-y-5 mt-10 w-11/12 mx-auto'>
        ...
        <div className='space-x-3'>
          <button className='btn border h-0 px-4 py-6 border-[#D2D2D2] shadow-none'><img src={playStore} className='w-8' alt="" /> Google Play</button>
          <button className='btn border h-0 px-4 py-6 border-[#D2D2D2] shadow-none'><img src={appStore} className='w-8' alt="" /> App Store</button>
        </div>
