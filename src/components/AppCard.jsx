  ...
  return (
    <div className="card bg-base-100 shadow-md rounded-md p-3 space-y-2">
      ...
      <div className='flex items-center justify-between'>
        <div className="badge py-3 rounded-sm bg-[#F1F5E8] text-[#00D390] badge-soft badge-success">
          <img className='w-4' src={downloadIcon} alt="" /> {downloads}
        </div>
        <div className="badge py-3 rounded-sm bg-[#FFF0E1] text-[#FF8811] badge-soft badge-warning">
