...
const AppDetails = () => {
  ...
  const { image, title, companyName, description, ratings, downloads, ratingAvg, size, reviews } = app || {};
    ...
    <div className='w-11/12 mx-auto'>
      ...
      <div>
        ...
        <div className='space-y-5 my-6'>
          {
            appInfo.map(info => <p className='text-xl text-justify text-[#627382] font-normal'>{info}</p>)
          }
        </div>
      </div>
    </div>
